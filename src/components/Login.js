      ...
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-purple-900 to-indigo-900 items-center justify-center p-12">
        <div className="text-center text-white max-w-md">
          <div className="mb-8">
            ...
            <h1 className="text-4xl font-bold mb-4">Continue Your Academic Journey</h1>
            <p className="text-purple-200">Access your courses, track progress, and connect with instructors.</p>
          </div>
          <div className="bg-purple-800 bg-opacity-50 rounded-2xl p-6 mt-8 border border-purple-700">
            <h3 className="font-semibold text-lg mb-3">Benefits of Your Account</h3>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-20 bg-gray-900">
        <div className="mx-auto w-full max-w-md">
          <div className="text-center mb-10">
            <div className="inline-flex items-center justify-center h-16 w-16 rounded-full bg-gradient-to-r from-purple-600 to-indigo-600 mb-6">
              <FaSignInAlt className="h-8 w-8 text-white" />
            </div>
            <h2 className="text-3xl font-extrabold text-white">Welcome Back</h2>
            <p className="mt-2 text-purple-200">Sign in to continue to your student portal</p>
          </div>
